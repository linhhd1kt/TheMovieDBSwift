...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/13129840/Services'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '13129840' => 'linh.hd@neo-lab.vn' }
  s.source           = { :git => 'https://github.com/13129840/Services.git', :tag => s.version.to_s }
  ...
  s.resource_bundles = {
      'Services' => ['Services/**/*.{png,jpeg,jpg,storyboard,xib,xcassets}']
  }
  
  s.resources = ['Services/**/*.{png,jpeg,jpg,storyboard,xib,xcassets}']
